...
type ControlCommand struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Action            ControlAction          `protobuf:"varint,1,opt,name=action,proto3,enum=gpu_sentry.telemetry.v1.ControlAction" json:"action,omitempty"`
...
const file_proto_telemetry_proto_rawDesc = "" +
	"\n" +
	"\x15proto/telemetry.proto\x12\x17gpu_sentry.telemetry.v1\"\xfa\x03\n" +
	"\bEnvelope\x12\x1d\n" +
	"\n" +
	...
	"\x03tid\x18\x05 \x01(\rR\x03tid\x12N\n" +
	"\fprocess_info\x18\n" +
	" \x01(\v2).gpu_sentry.telemetry.v1.ProcessInfoEventH\x00R\vprocessInfo\x12I\n" +
	"\fclient_hello\x18\v \x01(\v2$.gpu_sentry.telemetry.v1.ClientHelloH\x00R\vclientHello\x128\n" +
	"\x04code\x18\f \x01(\v2\".gpu_sentry.telemetry.v1.CodeEventH\x00R\x04code\x12Q\n" +
	"\rkernel_launch\x18\r \x01(\v2*.gpu_sentry.telemetry.v1.KernelLaunchEventH\x00R\fkernelLaunch\x12;\n" +
	"\x05stats\x18\x0e \x01(\v2#.gpu_sentry.telemetry.v1.StatsEventH\x00R\x05statsB\a\n" +
	"\x05event\"\xa4\x02\n" +
	...
	"\rqueued_events\x18\x03 \x01(\x04R\fqueuedEvents\"\xa2\x01\n" +
	"\x0eServerEnvelope\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12!\n" +
	"\ftimestamp_ns\x18\x02 \x01(\x04R\vtimestampNs\x12C\n" +
	"\acontrol\x18\n" +
	" \x01(\v2'.gpu_sentry.telemetry.v1.ControlCommandH\x00R\acontrolB\t\n" +
	"\acommand\"\xce\x01\n" +
	"\x0eControlCommand\x12>\n" +
	"\x06action\x18\x01 \x01(\x0e2&.gpu_sentry.telemetry.v1.ControlActionR\x06action\x12\x18\n" +
	...
	"\x18CONTROL_ACTION_TERMINATE\x10\x02B%Z#gpu-sentry/native/protocol;protocolb\x06proto3"
...
var file_proto_telemetry_proto_goTypes = []any{
	(ControlAction)(0),        // 0: gpu_sentry.telemetry.v1.ControlAction
	(*Envelope)(nil),          // 1: gpu_sentry.telemetry.v1.Envelope
	(*ProcessInfoEvent)(nil),  // 2: gpu_sentry.telemetry.v1.ProcessInfoEvent
	(*ClientHello)(nil),       // 3: gpu_sentry.telemetry.v1.ClientHello
	(*CodeEvent)(nil),         // 4: gpu_sentry.telemetry.v1.CodeEvent
	(*KernelLaunchEvent)(nil), // 5: gpu_sentry.telemetry.v1.KernelLaunchEvent
	(*StatsEvent)(nil),        // 6: gpu_sentry.telemetry.v1.StatsEvent
	(*ServerEnvelope)(nil),    // 7: gpu_sentry.telemetry.v1.ServerEnvelope
	(*ControlCommand)(nil),    // 8: gpu_sentry.telemetry.v1.ControlCommand
}
var file_proto_telemetry_proto_depIdxs = []int32{
	2, // 0: gpu_sentry.telemetry.v1.Envelope.process_info:type_name -> gpu_sentry.telemetry.v1.ProcessInfoEvent
	3, // 1: gpu_sentry.telemetry.v1.Envelope.client_hello:type_name -> gpu_sentry.telemetry.v1.ClientHello
	4, // 2: gpu_sentry.telemetry.v1.Envelope.code:type_name -> gpu_sentry.telemetry.v1.CodeEvent
	5, // 3: gpu_sentry.telemetry.v1.Envelope.kernel_launch:type_name -> gpu_sentry.telemetry.v1.KernelLaunchEvent
	6, // 4: gpu_sentry.telemetry.v1.Envelope.stats:type_name -> gpu_sentry.telemetry.v1.StatsEvent
	8, // 5: gpu_sentry.telemetry.v1.ServerEnvelope.control:type_name -> gpu_sentry.telemetry.v1.ControlCommand
	0, // 6: gpu_sentry.telemetry.v1.ControlCommand.action:type_name -> gpu_sentry.telemetry.v1.ControlAction
